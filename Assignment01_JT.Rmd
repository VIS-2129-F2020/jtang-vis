...
**P. S. Thank you Carole and team for the feedback:** I tried to calculate Housing Cost (HC) as a percentage of Household Income (HINCP), a.k.a. HC/HINCP. However, I did a quick spot check and for some reason some values did not equal the pre-calculated Gross Rent as a Percentage of Household Income (GRPIP, which I renamed HCPIP). Thus, I continued to use the dataset's GRPIP (renamed: HCPIP) versus my mutation of HC/HINCP.
...
* I started to get confused about what I have plotted and what I haven't -- which combinations I have exhausted vs. not. So I came up with a question:
  ...
  * I am trying to overlay 2 histograms, but to no avail. I would like the Burdened/Not as anothre categorical variable that gets plotted, and want to highlight the overlap. Is this possible? Following the overlay structure that I used in `geom_violin` above did not work here.
...
**Last Note to Self:** I am getting confused which dot plots do what... something to keep in mind. Also, I can ask a bunch of different questions and find out their different correlation "facts"/observations but what is the relationship between these things? From my current perspective, it seems difficult to tell the story without knowing causation / some qualitative data. An analogy I can make from thinking about my Land Use Law class is: I can know the facts of the case, but what are the implications of these facts? What facts/observations become background and what become major plot points?